...
public class MapTable {
    ...
    private bool TryGetKnownEntity(
        ...
        if (knownEntities.TryGetValue(entityId, out entity!)
            && knownLocations.TryGetValue(entityId, out location!)) return true;
    ...
    public bool TryCreateSafeDischargeTask(
        ...
        try {
            ...
            if (!found) {
                reason = "no in-map point is reachable by the loaded round";
                return false;
            }
