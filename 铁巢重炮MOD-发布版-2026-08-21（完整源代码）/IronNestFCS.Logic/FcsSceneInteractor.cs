...
public class FcsSceneInteractor {
    ...
    public static IEnumerator WaitAndClick(LookAtTarget? button) {
        ...
        // LookAtTarget stores its click deadline on Unity's scaled game clock.
        // Comparing it with realtime breaks after changing Time.timeScale (for
        // example X10 -> X1) and can leave an already usable button waiting.
        while (button.isActive == false || button.nextAllowedClickTime > Time.time) {
